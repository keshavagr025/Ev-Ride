    ...
    try {
        ...
        userWebSocket.onmessage = (event) => {
            ...
            if (data.type === "ride_accepted") {
                showAlert("✅ Driver has accepted your ride! Tracking started.", "success");
                startRideTracking();
            }
        };
...
async function bookRide() {
    ...
    try {
        ...
        showAlert(`✅ Ride booked! ${data.driver.name} is arriving. ₹${data.estimated_fare.toFixed(2)}`, "success");
...
function updateMapWithRide(pickup, dropoff, driver, optimizedRoute) {
    ...
    routeLine = L.polyline(routePoints, {
        ...
        opacity: 0.7,
        dashArray: '10, 10'
    }).addTo(map).bindPopup("🤖 AI-Optimized Route");
...
function startRideTracking() {
    ...
    rideInterval = setInterval(() => {
        ...
        if (progress > 100) {
            ...
            showAlert("🎉 Ride completed!", "success");
            resetRideUI();
        ...
        const html = `
            <div style="padding: 20px; background: linear-gradient(135deg, #f8fafc, #f1f5f9); border-radius: 16px; margin-bottom: 15px;">
                ...
                <div style="display: flex; justify-content: space-between;">
                    ...
                    <strong style="color: #22c55e;">₹${data.average_fare.toFixed(2)}</strong>
                </div>
                ${data.models_loaded ? 
        ...
        const html = data.drivers ? data.drivers.map(driver => `
            <div class="driver-card">
                ...
                <div class="driver-details">
                    ...
                    <div class="driver-vehicle">${driver.vehicle_type} • ${driver.ev_battery}% Battery</div>
                    <div class="driver-meta">
                        <span class="driver-rating">⭐ ${driver.driver_rating}</span>
                        <span class="driver-battery">🔋 ${driver.ev_battery}%</span>
                    </div>
                </div>
            </div>
            ...
            <div class="ride-item">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <div style="font-size: 18px; font-weight: 700; color: #22c55e;">
                        💰 ML Fare: ₹${currentRide.estimated_fare.toFixed(2)}
                    </div>
                </div>
...
async function completeRide() {
    ...
    try {
        ...
        showAlert(`✅ Ride completed! Earnings: ₹${data.fare.toFixed(2)}`, "success");
        ...
        const ridesHtml = `
            <div class="ride-item">
                ...
                <div style="font-size: 15px; color: #666;">
                    👤 User: USER_${Math.random().toString(36).substr(2, 6).toUpperCase()} | 🚗 Driver: Rajesh Kumar<br>
            ...
            <div class="ride-item">
                ...
                <div style="font-size: 15px; color: #666;">
                    👤 User: USER_${Math.random().toString(36).substr(2, 6).toUpperCase()} | 🚗 Driver: Amit Singh<br>
